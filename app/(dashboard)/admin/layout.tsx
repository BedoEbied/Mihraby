        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link href="/admin" className="text-2xl font-bold text-[var(--color-text-on-primary)] font-[family-name:var(--font-heading)]">
                Mihraby
              </Link>
              <div className="ms-4 sm:ms-10 flex gap-3 sm:gap-8 text-sm font-medium">
                ...
                <Link href="/admin/courses" className="text-[var(--color-text-on-primary)]/80 hover:text-[var(--color-text-on-primary)] transition-colors py-2">
                  Courses
                </Link>
              </div>
            </div>
