    ...
    <div className="bg-[var(--color-bg-white)] rounded-2xl p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(29,64,64,0.15)] border border-[var(--color-border-light)] max-w-md w-full">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-[var(--color-primary)] font-[family-name:var(--font-heading)]">
          Sign In<span className="text-[var(--color-accent)]">.</span>
        </h2>
        <p className="mt-2 text-sm text-[var(--color-text-muted)]">
          Access your Mihraby account
        </p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-[var(--color-text-secondary)]">
        ...
        <Link href="/register" className="font-medium text-[var(--color-accent)] hover:text-[var(--color-accent-light)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]/50 rounded transition-colors">
          Register
        </Link>
      </p>
